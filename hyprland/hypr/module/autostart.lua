...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("~/dotfiles/scripts/wmscripts/autostart_once.w.sh hyprland")
    ...
    -- hl.exec_cmd("swaybg -o HDMI-A-1 -i $(cat ~/dotfiles/scripts/wallpapers/selected/HDMI-A-1.txt) -m fill")
    -- hl.exec_cmd("swaybg -o HDMI-A-2 -i $(cat ~/dotfiles/scripts/wallpapers/selected/HDMI-A-2.txt) -m fill")
    -- hl.exec_cmd("swaybg -o HDMI-A-3 -i $(cat ~/dotfiles/scripts/wallpapers/selected/HDMI-A-3.txt) -m fill")
    hl.exec_cmd("~/dotfiles/scripts/wmscripts/autostart_always.w.sh hyprland")
...
hl.exec_cmd("~/dotfiles/scripts/apply-display-settings.w.sh hyprland")
-- hl.exec_cmd("~/dotfiles/scripts/wmscripts/autostart_always.w.sh hyprland")
