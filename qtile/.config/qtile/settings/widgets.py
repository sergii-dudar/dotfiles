...
# Define Widgets
widget_defaults = dict(font="JetBrainsMono Nerd Font", fontsize=12, padding=2, background=bg)
...
def init_widgets_list(monitor_num):
    widgets_list = [
        ...
        widget.Sep(linewidth=1, padding=10, foreground=color2, background=bg),
        widget.OpenWeather(
        ...
        widget.CheckUpdates(distro="Fedora", display_format="{updates} updates", font="JetBrainsMono Nerd Font", no_update_string="No Updates", update_interval=3600),
        widget.Sep(linewidth=0, padding=10),
        widget.TextBox(
            text="",
            fontsize=14,
        ...
        widget.CPU(font="JetBrainsMono Nerd Font", update_interval=1.0, format="{load_percent}%", foreground=fg, padding=5),
        widget.Sep(linewidth=0, padding=10),
        widget.TextBox(
            text="",
            fontsize=14,
        ...
        widget.Clock(format="%I:%M %p", font="JetBrainsMono Nerd Font", padding=10, foreground=fg),
        widget.Systray(
            background=bg,
            icon_size=20,
            padding=4,
