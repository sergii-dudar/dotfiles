...
logo = widget.TextBox(text="  ", font="JetBrainsMono Nerd Font", mouse_callbacks={"Button1": open_rofi}, fontsize=20, background=colors[3], margin=4, padding=3)
sep = widget.Sep(linewidth = 1, padding = 15, foreground = colors[0], background = colors[0])
spacer1 = widget.Spacer(length=1, background=colors[3], **slash_powerlineRight)
spacer2 = widget.Spacer(length=1, background=colors[0], **slash_powerlineLeft)
spacer3 = widget.Spacer(length=1, background=colors[6], **slash_powerlineLeft)
spacer4 = widget.Spacer(length=1, background=colors[3], **rounded_powerlineLeft)
spacer5 = widget.Spacer(length=1, background=colors[0], **rounded_powerlineRight)
spacer6 = widget.Spacer(length=1, background=colors[0], **slash_powerlineLeft)
spacer7 = widget.Spacer(length=1, background=colors[0], **slash_powerlineLeft)
spacer8 = widget.Spacer(length=1, background=colors[0], **slash_powerlineLeft)
spacer9 = widget.Spacer(length=1, background=colors[0], **slash_powerlineRight)
middle = widget.Spacer(background=colors[6])
shadow1 = widget.Spacer(length=3, background=colors[0], **slash_powerlineRight)
shadow2 = widget.Spacer(length=3, background=colors[0], **slash_powerlineLeft)
shadow4 = widget.Spacer(length=3, background=colors[0], **rounded_powerlineLeft)
shadow5 = widget.Spacer(length=3, background=colors[0], **rounded_powerlineRight)
...
curlayout = widget.CurrentLayout(background=colors[4], foreground=colors[0], font="JetBrainsMono Nerd Font Bold")
curlayouticon= widget.CurrentLayoutIcon(padding=5, scale=0.5, custom_icon_paths=["~/.config/qtile/Assets/layout"])

searchicon = widget.TextBox(text=" ", font="Font Awesome 6 Free Solid", fontsize=13, background=colors[0], foreground=colors[7], mouse_callbacks={"Button1": open_rofi})

search = widget.TextBox(fmt='Search', background=colors[0], font="JetBrainsMono Nerd Font Bold", fontsize=13, foreground=colors[7], mouse_callbacks={"Button1": open_rofi})
