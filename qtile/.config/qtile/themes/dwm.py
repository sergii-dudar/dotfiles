...
mem = widget.Memory(font = "JetBrainsMono Nerd Font", foreground = colors[2], background = colors[0], format = '{MemUsed: .0f}{mm} /{MemTotal: .0f}{mm}', measure_mem='G', padding = 5,)
...
curlayout = widget.CurrentLayoutIcon(scale = 0.5, foreground = colors[0], background = colors[11], padding = 10,)
