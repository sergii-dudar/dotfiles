...
layout_theme = {"margin": 10, "border_width": 2, "border_focus": colors[0], "border_normal": colors[0]}
...
groupbox = widget.GroupBox(font="JetBrainsMono Nerd Font Mono", fontsize=20, margin_y=4, margin_x=4, padding_y=6, padding_x=6, borderwidth=2, disable_drag=True, active=colors[11], inactive=colors[5], hide_unused=True, rounded=True, highlight_method="line", highlight_color=colors[6], this_current_screen_border=colors[0], this_screen_border=colors[0], other_current_screen_border=colors[2], other_screen_border=colors[8], urgent_alert_method="line", urgent_border=colors[6], urgent_text=colors[1], foreground=colors[0], background=colors[0], use_mouse_wheel=False)  # unfocused  # box color
