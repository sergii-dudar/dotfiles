## Ids to use in shell cmd `open "{prefId}"`
...
x-apple.systempreferences:com.apple.Coverage-Settings.extension?showCoverageDetails_link/
...
x-apple.systempreferences:com.apple.LoginItems-Settings.extension?Section_Extensions
...
x-apple.systempreferences:com.apple.preference.screentime?ContentAndPrivacy
