...
myNormColor = "#d6d6d6"             -- unfocus window border
myFocusColor = "#b05279"            -- focus window border
myppCurrent = "#9e86c8"             -- current workspace in xmobar
myppVisible = "#d6d6d6"             -- visible but not current workspace
myppHidden = "#a3be8c"              -- hidden workspace in xmobar
myppHiddenNoWindows = "#d8dee9"     -- hidden workspace(no windows)
myppTitle = "#b4d273"               -- active window title in xmobar
myppUrgent = "#b05279"              -- urgen workspace
