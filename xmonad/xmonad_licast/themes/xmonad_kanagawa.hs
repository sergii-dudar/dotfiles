...
myNormColor = "#f8f8f2"             -- unfocus window border
myFocusColor = "#6272a4"            -- focus window border
myppCurrent = "#bd93d9"             -- current workspace in xmobar
myppVisible = "#f8f8f2"             -- visible but not current workspace
myppHidden = "#a3be8c"              -- hidden workspace in xmobar
myppHiddenNoWindows = "#d8dee9"     -- hidden workspace(no windows)
myppTitle = "#ff79c6"               -- active window title in xmobar
myppUrgent = "#ff5555"              -- urgen workspace
