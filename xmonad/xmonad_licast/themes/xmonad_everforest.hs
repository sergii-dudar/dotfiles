...
myNormColor = "#d3c6aa"             -- unfocus window border
myFocusColor = "#374145"            -- focus window border
myppCurrent = "#a7c080"             -- current workspace in xmobar
myppVisible = "#d3c6aa"             -- visible but not current workspace
myppHidden = "#a3be8c"              -- hidden workspace in xmobar
myppHiddenNoWindows = "#d8dee9"     -- hidden workspace(no windows)
myppTitle = "#d699b6"               -- active window title in xmobar
myppUrgent = "#e67e80"              -- urgen workspace
