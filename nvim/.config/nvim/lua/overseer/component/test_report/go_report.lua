local test_report = require("modules.go.test-report")
...
return {
    desc = "Parse `go test -json` output and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the go-test JSON report directory or directories",
        },
        filetype = {
            type = "string",
