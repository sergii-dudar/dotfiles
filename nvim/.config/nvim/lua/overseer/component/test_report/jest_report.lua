local test_report = require("modules.js.test-report")
...
return {
    desc = "Parse jest --json output and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the jest JSON report directory or directories",
        },
        filetype = {
            type = "string",
