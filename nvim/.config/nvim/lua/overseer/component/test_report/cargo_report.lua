local test_report = require("modules.rust.test-report")
...
return {
    desc = "Parse cargo-nextest JUnit XML reports and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the nextest JUnit XML report directory or directories",
        },
        filetype = {
            type = "string",
