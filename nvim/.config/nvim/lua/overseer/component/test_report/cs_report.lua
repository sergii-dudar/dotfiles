local test_report = require("modules.cs.test-report")
local log = require("utils.logging-util").new({
    name = "test-report-component-cs",
...
return {
    desc = "Parse `dotnet test` TRX reports and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the TRX report directory or directories",
        },
        filetype = {
            type = "string",
