local test_report = require("modules.bash.test-report")
...
return {
    desc = "Parse bashunit JUnit XML output and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the bashunit JUnit XML report directory or directories",
        },
        filetype = {
            type = "string",
