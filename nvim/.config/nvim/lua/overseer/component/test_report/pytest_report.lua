local test_report = require("modules.python.test-report")
...
return {
    desc = "Parse pytest JUnit XML output and display results as signs and diagnostics",
    params = {
        report_dir = {
            desc = "Path to the pytest JUnit XML report directory or directories",
        },
        filetype = {
            type = "string",
