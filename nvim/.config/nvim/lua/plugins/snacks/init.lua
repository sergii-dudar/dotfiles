...
return {
    {
        ...
        keys = {
            ...
            { "<leader>br", function() require("plugins.snacks.configs.pickers").pick_resource_path({ mode = "n" }) end, desc = "Pick Resource Path" },
            { "<leader>br", ":<C-u>lua require('plugins.snacks.configs.pickers').pick_resource_path({ mode = 'v' })<CR>", desc = "Pick Resource Path", mode = "x" },
